...
PHP 8.3 or 8.4, Xdebug 3, and Docker Desktop on Windows.
...
3. Set the host to your vhost, keep the debugger as **Xdebug**, and enable
   path mappings.
4. Map `C:\Users\cytopia\repo\devilbox\data\www\myapp` to
   `/shared/httpd/myapp`.
...
:::caution
If PhpStorm never receives a connection, allow PhpStorm through Windows
