---
title: "Add project hosts entry on Linux"
---
...
On Linux, custom DNS entries can be added to the `/etc/hosts` and will
...
1.  Open `/etc/hosts` with root privileges or via `sudo` with your
    favorite editor
