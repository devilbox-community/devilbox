---
title: "Custom scripts globally"
---

# Custom scripts globally

You can provide custom startup commands via bash scripts that are
executed by all PHP container. This may be useful to specify additional
...
You can add shell scripts that are executed for all PHP container
equally.
...
Custom scripts are added by placing a file into `autostart/`. The file
