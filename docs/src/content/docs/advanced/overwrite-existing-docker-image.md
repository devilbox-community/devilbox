---
title: "Overwrite existing Docker image"
---
...
1.  Copy the whole service definition from docker-compose.yml to
    docker-compose.override.yml
...
The second step is to remove everything that you do not need to
overwrite:
...
The last step is to actually adjust the value you want to change for the
bind service:
