...
function Usage {
  case "$1" in
    --ansi)
      ...
      echo "${GREEN}" "agent${NORMAL}            Control agentic AI-coding container (subcommand: dvl agent help)"
    ...
    --no-ansi)
      ...
      echo " agent            Control agentic AI-coding container (subcommand: dvl agent help)"
